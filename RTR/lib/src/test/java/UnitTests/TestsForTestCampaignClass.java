...
import RemoteTestReporter.ConnectionClient;
import RemoteTestReporter.TestCampaign;
...
public class TestsForTestCampaignClass {
    ...
    void setup() throws Exception {
        String data = JsonApiHandler.createJSONForNewTestCampaign(campaignName, envName, "user");
        when(conn.sendRequest(HttpMethod.POST, url + "begin", data)).thenReturn(
                "{\"campaignName\":\"Test strony www\",\"envName\":\"CI pipeline #1\"," +
                        "\"testCampaignID\":" + dummyCampaignID + " ,\"begTime\":\"2022-03-03T17:50:31\"," +
        ...
        testCampaign = new TestCampaign(conn, campaignName, envName, "user");
    }
